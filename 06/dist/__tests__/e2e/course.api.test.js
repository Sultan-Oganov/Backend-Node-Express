...
describe('/course', () => {
    ...
    it('create one more course', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield (0, supertest_1.default)(app_1.app)
            .get('/courses')
            .expect(index_1.HTTP_STATUSES.OK_200, [createdCourse, createdCourse2]);
    }));
    ...
    it('should update course with correct input data', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield (0, supertest_1.default)(app_1.app)
            .get('/courses/' + createdCourse.id)
            .expect(index_1.HTTP_STATUSES.OK_200, Object.assign(Object.assign({}, createdCourse), { title: data.title }));
        yield (0, supertest_1.default)(app_1.app)
            .get('/courses/' + createdCourse2.id)
            .expect(index_1.HTTP_STATUSES.OK_200, createdCourse2);
    }));
