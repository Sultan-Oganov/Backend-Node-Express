...
app.get('/courses/:id', (req: TypedRequestParams<URIParamsCourseIdModel>, res: Response<CourseViewModel>) => {
...
app.post('/courses/', (req: TypedRequestBody<CreateCourseModel >, res: Response<CourseViewModel>) => {
    if (!req.body.title) {
...
app.delete('/courses/:id', (req: TypedRequestParams<URIParamsCourseIdModel>, res:Response<CourseViewModel>) => {
    db.courses = db.courses.filter(course => course.id !== Number(req.params.id));
    res.sendStatus(HTTP_STATUSES.NO_CONTENT_204);
});

app.put('/courses/:id', (req: TypedRequestParamsAndBody<URIParamsCourseIdModel, {title: string}>, res) => {
